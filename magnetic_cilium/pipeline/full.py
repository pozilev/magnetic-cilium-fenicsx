...
def build_full_pipeline_plan(config: SimulationConfig, ctx: RunContext) -> list[PipelineStep]:
    ...
    return [
        ...
        PipelineStep("solve_mechanics", enabled=config.run.mode in {"full", "mechanics"}, backend="legacy-fem"),
        PipelineStep("postprocess_mechanics", enabled=config.run.mode in {"full", "mechanics"}, backend="legacy-fem"),
        PipelineStep("save_restart", enabled=config.run.mode in {"full", "mechanics"}, backend="legacy-fem"),
        PipelineStep("solve_magnetics_dipole", enabled=magnetic_enabled, backend="legacy-dipole"),
