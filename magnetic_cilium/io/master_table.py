...
MASTER_COLUMNS = [
    ...
    "Br_T", "M_magnitude_A_per_m", "magnetization_mode", "magnetization_model",
    "rotate_magnetization", "dipole_mode", "theta_mu_deg", "follow_factor_alpha", "n_point_dipoles",
    ...
    "magnetic_source_cells", "magnetic_dipole_points", "magnetic_dipole_points_requested",
    ...
    "theta_mu_to_global_z_mean_deg", "geometry_theta_to_global_z_mean_deg",
    "theta_mu_minus_geometry_theta_mean_deg", "magnetization_sum_moment_norm_A_m2",
...
def build_magnetic_master_row(
    ...
    *,
    ...
    row = {
        ...
        "magnetization_mode": result_value(
            result,
            "magnetization_model",
            default="rotated" if as_bool(result.get("rotate_magnetization"), True) else "fixed",
        ),
        "magnetization_model": result_value(result, "magnetization_model"),
        "rotate_magnetization": result_value(result, "rotate_magnetization", default=True),
        "dipole_mode": result_value(result, "dipole_mode"),
        "theta_mu_deg": result_value(result, "theta_mu_deg"),
        "follow_factor_alpha": result_value(result, "follow_factor_alpha"),
        "n_point_dipoles": result_value(result, "n_point_dipoles"),
        ...
        "magnetic_source_cells": result_value(result, "magnetic_source_cells"),
        "magnetic_dipole_points": result_value(result, "magnetic_dipole_points"),
        "magnetic_dipole_points_requested": result_value(result, "magnetic_dipole_points_requested"),
        "magnetization_mean_unit_x": result_value(result, "magnetization_mean_unit_x"),
        "magnetization_mean_unit_y": result_value(result, "magnetization_mean_unit_y"),
        "magnetization_mean_unit_z": result_value(result, "magnetization_mean_unit_z"),
        "dipole_magnetization_angle_to_normal_mean_deg": result_value(result, "dipole_magnetization_angle_to_normal_mean_deg"),
        "theta_mu_to_global_z_mean_deg": result_value(result, "theta_mu_to_global_z_mean_deg"),
        "geometry_theta_to_global_z_mean_deg": result_value(result, "geometry_theta_to_global_z_mean_deg"),
        "theta_mu_minus_geometry_theta_mean_deg": result_value(result, "theta_mu_minus_geometry_theta_mean_deg"),
        "magnetization_sum_moment_norm_A_m2": result_value(result, "magnetization_sum_moment_norm_A_m2"),
